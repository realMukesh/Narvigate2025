    ...
    return CustomIconButton(
      ...
      child:  Padding(
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset(ImageConstant.icAddEvent, height: 14.adaptSize,color: black,),
            SizedBox(width: 6.adaptSize,),
            const Flexible(child: CustomTextView(text: "Add",fontSize: 14,
              fontWeight: FontWeight.normal,color: colorSecondary,))
          ],
        ),
      ),
    );
