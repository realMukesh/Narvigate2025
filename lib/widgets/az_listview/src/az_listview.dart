...
class AzListView extends StatefulWidget {
  ...
  final Function(String) onIndexTap;
...
class _AzListViewState extends State<AzListView> {
  ...
  void _valueChanged() {
    ...
    if (details.action == IndexBarDragDetails.actionUp ||
        details.action == IndexBarDragDetails.actionEnd) {
      selectTag = tag;
      _scrollTopIndex(tag);
      widget.onIndexTap(tag);
      print("@@ valueChanged position");
    }
  }
