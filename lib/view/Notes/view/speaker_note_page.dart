...
class SpeakerNoteList extends GetView<MyNotesController> {
  SpeakerNoteList({super.key, required this.index});
  int index;
  ...
  Widget _progressEmptyWidget() {
    return Center(
      child: controller.isLoading.value
          ? const Loading()
          : controller.speakerNotesList.isEmpty && !controller.firstLoading.value
      ...
      child: RefreshIndicator(
        ...
        child: Skeletonizer(
          ...
          child: controller.firstLoading.value
              ...
              shrinkWrap: false,
              itemCount: controller.speakerNotesList.length,
              itemBuilder: (context, index) {
                return itemsDetailsWidget(
                    context, controller.speakerNotesList[index]);
              }),
        ),
      ),
    );
                            ...
                            onPressed: () async {
                              if (formKey.currentState?.validate() ?? false) {
                                ...
                                if (editNotesController.text
                                  ...
                                  controller.speakerNotesList.refresh();
