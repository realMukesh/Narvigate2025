...
class BootNoteList extends GetView<MyNotesController> {
  BootNoteList({super.key, required this.index});
  ...
  Widget _progressEmptyWidget() {
    return Center(
      child: controller.isLoading.value
          ? const Loading()
          : controller.boothNotesList.isEmpty && !controller.firstLoading.value
      ...
      child: RefreshIndicator(
        ...
        child: Skeletonizer(
          ...
          child: controller.firstLoading.value
              ...
              shrinkWrap: false,
              itemCount: controller.boothNotesList.length,
              itemBuilder: (context, index) {
                return itemsDetailsWidget(
                    context, controller.boothNotesList[index]);
              }),
        ),
      ),
    );
                            ...
                            onPressed: () async {
                              if (formKey.currentState?.validate() ?? false) {
                                ...
                                if (editNotesController.text
                                  ...
                                  controller.boothNotesList.refresh();
