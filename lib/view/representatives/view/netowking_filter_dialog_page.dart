...
import '../controller/networkingController.dart';

class NetworkingFilterDialog extends GetView<NetworkingController> {
  String role;
  NetworkingFilterDialog({super.key, required this.role});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
          ...
          padding:
              const EdgeInsets.only(top: 16, bottom: 10, right: 15, left: 15),
          decoration: AppDecoration.outlineBlack.copyWith(
            borderRadius: BorderRadiusStyle.customBorderTL18,
          ),
          child: GetX<NetworkingController>(builder: (controller) {
            return Stack(
              children: [
                Column(
                  children: [
  ...
  Widget _buildSortWidget(Filters? filter) {
    return Container(
      ...
      decoration: AppDecoration.greyBoxF4F3F7.copyWith(
            ...
            children: [
              InkWell(
                  onTap: () {
                    ...
                    controller.selectedSort(filter?.value);
              ...
              child: DropdownButton2<Options>(
                      ...
                      children: [
                        CustomTextView(
                          text: filter?.value != null &&
                              ...
                              : filter?.placeholder.toString() ?? "Select Item",
                          textAlign: TextAlign.start,
                ...
                items: filter?.options
                    ?.map((Options option) => DropdownMenuItem<Options>(
                          value: option,
                          child: ListTile(
                            leading: filter.value.toString() == option.id
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: CustomTextView(text:
                                    item.name.toString(),fontSize: 15,
                                  ),
                                ),
                              ],
                            ),
  ...
  PreferredSizeWidget _buildAppbar() {
    return CustomAppBar(
      ...
      title: const ToolbarTitle(title: "Filters"),
      backgroundColor: colorLightGray,
      dividerHeight: 0,
    );
  }
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                CustomImageView(
                    imagePath: "assets/svg/reset_icon.svg", width: 13.h),
              ],
            ),
          ),
        )
