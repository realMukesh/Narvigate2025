    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          trailing: createFieldBody.value!.isEmpty?const Icon(Icons.check_circle,color: white,):option.isTrue!?const Icon(Icons.check_circle,color: white,):const Icon(Icons.cancel,color: white,),
        ),
      ),
    );
  }
