...
class MeetingDetailPage extends GetView<MeetingController> {
                    ...
                    children: [
                      ListTile(
                        ...
                        title: Row(
                          ...
                          children: [
                            CustomTextView(
                              text: controller.meetingDetailBody.location ?? "",
                      ...
                      controller.meetingDetailBody.message?.isNotEmpty == true
                          ? ListTile(
                              ...
                              subtitle: Padding(
                                padding: const EdgeInsets.only(top: 6),
                                child: CustomTextView(
                                  text: controller.meetingDetailBody.message ??
                                      "",
                      ...
                      controller.meetingDetailBody.completionMessage
                                  ...
                                  true &&
                              ["1", "-1"].contains(
                                  controller.meetingDetailBody.completionStatus)
                          ? ListTile(
                              contentPadding: EdgeInsets.zero,
                              title: const CustomTextView(
                                text: "Message",
  ...
  buildManageStatus(Meetings meetings, BuildContext context) {
    ...
    var mCurrentDate =
        UiHelper.getCurrentDate(timezone: controller.authManager.getTimezone());
