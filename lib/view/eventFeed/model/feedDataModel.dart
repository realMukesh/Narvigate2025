...
class Emoticon {
  ...
  Emoticon({required this.status, this.type, this.total, required this.count,});
...
class Filters {
  ...
  Filters({this.page, this.type, this.hasNextPage});
