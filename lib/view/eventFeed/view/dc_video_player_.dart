...
class DCVideoPLayer extends StatefulWidget {
  Posts posts;
  bool isFullScreen;
  ...
  @override
  State<DCVideoPLayer> createState() => _FeedListVideoPLayer();
}

class _FeedListVideoPLayer extends State<DCVideoPLayer>
  ...
  void initState() {
    ...
    videoPlayerController = VideoPlayerController.networkUrl(
      Uri.parse(widget.posts.video.toString() ?? ""),
    )..initialize().then((_) {
        setState(() {
