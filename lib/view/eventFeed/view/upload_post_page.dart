...
import 'package:dreamcast/widgets/streemingPlayer/better_player.dart';
...
class _UploadPostPageState extends State<UploadPostPage> {
                          ...
                          child: Row(
                            ...
                            children: [
                              CustomImageWidget(
                                ...
                                shortName: authenticationManager.getUsername(),
                                size: 30,
                                fontSize: 12,
                                color: white,
                              ),
                              ...
                              CustomTextView(
                                text:
                                    authenticationManager.getName().toString(),
                                fontSize: 16,
                                maxLines: 2,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                      ...
                                      icon: buildIconWidget(ImageConstant
                                          .ic_video) /*Stack(
                                        alignment: Alignment.center,
                                        children: [
                                          Container(
    ...
    return Stack(
      ...
      children: [
        Container(
          padding: const EdgeInsets.all(0),
          decoration: const BoxDecoration(
              shape: BoxShape.circle, color: colorLightGray),
        ),
        SvgPicture.asset(
          url,
          height: 26,
  ...
  playLocalVideo(BuildContext context) {
    return Container(
        ...
        url: controller.mediaPath.value,
      ),*/
        );
  }
