...
class AiMatchesSpeakerPage extends GetView<AiMatchController> {
 ...
 final SpeakersDetailController userController = Get.put(SpeakersDetailController());
  ...
  refreshListApi({required String search}) {
    controller.getDataByIndexPage(2);
  }
  ...
  Widget buildListview(BuildContext context) {
    return Skeletonizer(
        ...
        child: controller.isFirstLoading.value?const SpeakerListSkeleton():ListView.builder(
      ...
      child: InkWell(
        onTap: () async {
          ...
          await userController.getSpeakerDetail(
              speakerId:representatives.id, role:representatives.role,isSessionSpeaker: false);
