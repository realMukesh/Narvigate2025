  ...
  buildParentMenuBody(int index, BuildContext context) {
    ...
    return CommonMenuButton(
      ...
      widget: Column(
        ...
        children: [
          SvgPicture.network(
            //color: Colors.blue, // Replace with your desired tint color
            //colorBlendMode: BlendMode.srcIn, // This applies the color to the entire SVG
            menuData.icon ?? "",
            height: 32.h,
      ...
      child: CommonMenuButton(
        ...
        widget: Padding(
          ...
          child: Column(
            ...
            children: [
              SvgPicture.network(
                //color: colorSecondary, // Replace with your desired tint color
                //colorBlendMode: BlendMode.srcIn, // This applies the color to the entire SVG
                menuData.icon ?? "",
                height: 45.adaptSize,
                color: colorPrimaryDark,
