...
class InfoAboutPage extends GetView<InfoFaqController> {
  ...
  Widget build(BuildContext context) {
    return GetX<InfoFaqController>(builder: (controller){
      return Stack(
        children: [
                  ...
                  Column(
                    ...
                    children: [
                      Skeletonizer(
                        ...
                        child: controller.isFirstLoading.value?const AboutSkeletonWidget():
                        (controller.configDetailBody.value.description==null && !controller.isFirstLoading.value)
                            ||(controller.configDetailBody.value.description!.isEmpty && !controller.isFirstLoading.value)?
                        const SizedBox():
                        Container(
                          ...
                          child: CustomTextDescView(
                            ...
                            text: controller.configDetailBody.value.description ?? "",
                          ),
                        ),
                      ),
                      SizedBox(
                      ...
                      controller.configDetailBody.value.socialLinks !=null &&
                        controller.configDetailBody.value.socialLinks!.isNotEmpty
                        ?  buildSocialLink(context) : const SizedBox(),
                      SizedBox(
                        height: 30.v,
                      ),
                    ],
  ...
  Widget _progressEmptyWidget() {
    return Container(
      ...
      child: controller.isFirstLoading.value?const SizedBox():
      (controller.configDetailBody.value.description==null && !controller.isFirstLoading.value)||(controller.configDetailBody.value.description!.isEmpty && !controller.isFirstLoading.value)
          ? ShowLoadingPage(
