...
class _ChatDetailPageState extends State<ChatDetailPage> {
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          style: GoogleFonts.getFont(MyConstant.currentFont,
                                              fontSize: 16.fSize, color: colorSecondary, fontWeight: FontWeight.normal),
                                          decoration: InputDecoration(
                                              hintStyle: GoogleFonts.getFont(MyConstant.currentFont,
                                                  fontSize: 16.fSize, color: colorGray, fontWeight: FontWeight.normal),
  ...
  Widget pendingRequestSender() {
    return widget.userModel.iam == controller.authManager.getUserId()
        ? Container(
            width: context.width,
  ...
  Widget pendingRequestReceiver() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          CustomTextView(text:"chat_request_received".tr,fontSize: 14,),
          Row(
            children: [
              Expanded(
                  child: CommonChatButton(
                color: colorPrimary,
                textColor: white,
                height: 40,
                radius: 23,
