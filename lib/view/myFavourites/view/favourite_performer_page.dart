...
class FavouritePerformerPage extends GetView<FavPerformerController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: GetX<FavPerformerController>(builder: (controller) {
          return Stack(
            children: [
              RefreshIndicator(
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          await userController.getSpeakerDetail(speakerId: representatives.id,
              role:representatives.role ?? MyConstant.speakers,isSessionSpeaker: false);
