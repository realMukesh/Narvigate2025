...
class FavouriteExhibitorsPage extends GetView<FavBootController> {
  ...
  final exhibitorsController = Get.put(BootController());
  ...
  Widget _progressEmptyWidget() {
    return Center(
      child: controller.loading.value || exhibitorsController.isLoading.value
          ? const Loading()
          : !controller.isFirstLoading.value &&
                  controller.favouriteBootList.isEmpty
              ? ShowLoadingPage(refreshIndicatorKey: controller.refreshIndicatorKey)
              : const SizedBox(),
    );
  }
