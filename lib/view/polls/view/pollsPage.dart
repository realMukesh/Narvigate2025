                      ...
                      ? CommonMaterialButton(
                          ...
                          onPressed: () {
                            if (controller.isAnswerd.value) {
                              ...
                              var opinion = controller
                                  .getLivePoll()[0]
                                  .options?[controller.selectedTabIndex.value];
                              if (opinion != null &&
        ...
        () => Container(
          ...
          child: ListTile(
            ...
            trailing: controller.selectedTabIndex.value == index
                ? const Icon(Icons.radio_button_checked_outlined, color: colorPrimary,size: 22)
            : SvgPicture.asset(
                ImageConstant.icRadioInactive, height: 22.v, width: 22.h,),
          ),
        ),
      ),
    );
